...
async def on_ready():
    ...
    await client.change_presence(game=discord.Game(name=Serving X3MIS))
    await bot.join_voice_channel(discord.utils.find(lambda c: c.name == 'titanium' and c.type == 'voice', some_list_of_channels))
